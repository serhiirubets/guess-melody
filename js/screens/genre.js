...
const finishScreens = [winnerScreen, liveEndResultScreen, timeEndResultScreen];
...
const onFormSubmit = () => {
  const randomFinishScreen = finishScreens[randomInteger(0, finishScreens.length - 1)];
  showScreen(randomFinishScreen);
};
